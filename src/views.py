...
def api_currency(user_settings: str):
    """функция возвращающая запрос API согласно файла пользовательской конфигурации"""

    # получение пользовательских данных
    with open("../data/" + user_settings) as f:
        file = json.load(f)
...
def api_stoks(user_settings: str):
    """"""
